...
def importar_salao99():
    ...
    d = request.json or {}
    # Espera: { clientes: "<csv>", servicos: "<csv>", colaboradores: "<csv>", atendimentos: "<csv>" }
    def parse_csv(txt):
        if not txt: return []
        # Remove BOM
        txt = txt.lstrip('\ufeff')
    ...
    # Mapas nome→id para ligar atendimentos
    ...
    try:
        ...
        for r in ats:
            ...
            # Se cliente não existe, cria na hora
            if not cli_id:
